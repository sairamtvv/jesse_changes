...
from jesse.services.redis import main_redis

from jesse.services.redis import async_publish, sync_publish
...
async def redis_startup():
    global async_redis, sync_redis
    async_redis, sync_redis = await main_redis()
    print(f"async_redis = {async_redis}")
